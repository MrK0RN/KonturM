    ...
    private const DEFAULT_CATALOG = [
        'groups' => [
            [
                ...
                'items' => [
                    ['id' => 'i-default-1', 'filename' => 'Сертификат   ОТ Мерники М1Р.pdf', 'label' => null],
                    ['id' => 'i-default-2', 'filename' => 'Сертификат   ОТ Мерники М2Р.pdf', 'label' => null],
                    ['id' => 'i-default-3', 'filename' => 'Сертификат   ОТ Метроштоки МШС.pdf', 'label' => null],
                    ['id' => 'i-default-4', 'filename' => 'Сертификат   ОТ Технические мерники.pdf', 'label' => null],
                    ['id' => 'i-default-5', 'filename' => 'Сертификат   ОТ на Рулетки Р.pdf', 'label' => null],
                ],
            ],
            [
                'id' => 'g-default-2',
                ...
                'items' => [
                    ['id' => 'i-default-6', 'filename' => 'Сертификат Водочувствительная паста.pdf', 'label' => null],
                    ['id' => 'i-default-7', 'filename' => 'Титульный Лист ТУ на пасту Акватест.pdf', 'label' => null],
                ],
            ],
        ],
    ];
