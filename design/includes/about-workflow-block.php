        ...
        <div class="ab-workflow__shell">
          ...
          <ol class="ab-workflow__track" role="list">
            <li class="ab-workflow__card">
              ...
              <p class="ab-workflow__text">
                Вы направляете запрос на продукцию. Мы уточняем назначение изделия, объём, материал, требования ГОСТ
                и необходимость поверки
              </p>
              <div class="ab-workflow__cta-wrap">
                <div class="ab-workflow__result">
                  <p class="ab-workflow__result-label">Результат</p>
                  <p class="ab-workflow__result-text">Зафиксированные технические параметры и требования</p>
                </div>
            ...
            <li class="ab-workflow__card">
              <div class="ab-workflow__card-top">
                ...
                <h3 class="ab-workflow__card-title">
                  Расчёт и подготовка<br />
                  предложения
                </h3>
              </div>
              <p class="ab-workflow__text">
                Подбираем типовое изделие или предлагаем решение под задачу. Формируем коммерческое предложение с ценой,
                сроками изготовления и условиями поставки
              </p>
              <div class="ab-workflow__result">
                <p class="ab-workflow__result-label">Результат</p>
            ...
            <li class="ab-workflow__card">
              ...
              <p class="ab-workflow__text">
                Запускаем изделие в производство на собственных линиях. Проводим контроль качества и, при необходимости,
                поверку средств измерений в рамках аккредитации.
              </p>
              <div class="ab-workflow__result">
                <p class="ab-workflow__result-label">Результат</p>
            ...
            <li class="ab-workflow__card">
              ...
              <p class="ab-workflow__text">
                Упаковываем продукцию, организуем отгрузку. Передаём полный комплект документов и остаёмся на связи после
                поставки.
              </p>
              <div class="ab-workflow__result">
                <p class="ab-workflow__result-label">Результат</p>
                <p class="ab-workflow__result-text">Поставка с документацией и поддержкой</p>
              </div>
            </li>
          </ol>
          </div>
